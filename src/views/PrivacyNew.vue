<template>
  <div
    class="basic_privacy_cont_ w-full flex flex-col justify-center items-center"
  >
    <Navbar />
    <div
      class="basic_child_privacy_cont_ max-w-5xl w-full flex flex-col gap-4 justify-start lg:px-16 md:px-6 px-4 py-6"
    >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Decast.live, 463 Avenue Lalonde State :
            Québec City : Sainte-Bernadette.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Decast.live, accessible from
            <a
              href="https://decast.live/"
      ...
      <ul>
        <li>By email: support@cast.com</li>
      </ul>
    </div>
    <FootSec />
  </div>
