        ...
        <div class="lg:w-full md:w-8/12 sm:w-10/12 w-full">
          ...
          <div class="op-2 mt-2">
            <p class="text-base text-left">
              Users will get airdrops on events, compete on challenges to mint
              and upgrade <br class="xl:block hidden" />
              their Avatars. Watch live events in the most reliable way, as a
              fan.
            </p>
          </div>
          <div class="op-3">
        ...
        <div class="cont-3 flex justify-end items-center w-full" @scroll="handleScroll">
          <div class="rounded-lg relative p-6 basic__section__img" style="width: 500px;">
            <img class="rounded-lg object-cover w-full h-full"
              src="@/assets/images/landing/sponsors/sponsors__cover.png" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div
        ...
        <div class="flex flex-col text-grey gap-4 w-full col-span-1 lg:order-last lg:justify-end lg:items-end">
          <div class="flex-col flex md:w-10/12 sm:w-10/12">
            ...
            <h5 class="lg:text-5xl text-4xl text-grey font-semibold">
              Why Promote Cast Creators?
            </h5>
            <div class="w-64 my-4 h-2 rounded-full" style="background-color: #d7df23"></div>
            <p class="text-base text-grey font-normal">
              CAST NFTs brings value to the Fans and Creators involved in the
              CAST community. <br /><br />
              MINT a 'CREED' NFT. This is your basic Avatar to attend a cast.
              You can stay anonymous or choose to personalize. Your
              participation is tied to these NFTs and all other collectibles
              like tickets, NFT drops will be further tied to this CREED.
              <br /><br />
              You can own multiple CREED NFTs and trade
              <br /><br />
              Buy and sell CREED NFTs using the integrated plugin marketplace,
              Compete in challenges to upgrade your NFTs, Trade or HODL them
              while Generation drops adds more value to them, Provide liquidity
              to Subscribers- the network and earn event fees.
            </p>
          </div>
        </div>
        <div class="basic__section__img w-full md:w-auto relative flex object-cover col-span-1 justify-start">
          <img class="rounded-lg object-cover sm:w-10/12 w-full"
            src="@/assets/images/landing/sponsors/sponsors1.png" />
        </div>
      </div>
    </div>
