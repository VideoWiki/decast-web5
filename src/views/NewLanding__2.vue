        ...
        >
          <div class="flex-col flex md:w-10/12 sm:w-10/12">
            ...
            <p class="text-base text-grey font-normal">
              ...
              opportunities for innovation and self-expression. Other than the
              usual advantages of decentralization with governance and
              ownership, Decentralized and Distributed systems will provide
              better performance and resilience to build applications in future.
            </p>
          </div>
        </div>
        <div
        ...
        >
          <div class="flex-col flex md:w-10/12 sm:w-10/12">
            ...
            <p class="text-base text-grey font-normal">
              ...
              contributors to collectively shape the future of digital services
            </p>
          </div>
        </div>
        <div
      ...
      >
        <div class="flex flex-col text-grey gap-4 w-full col-span-1">
          ...
          <p class="text-base text-grey font-normal md:w-10/12 sm:w-10/12">
            ...
            the community supports the ongoing infrastructure maintenance and
