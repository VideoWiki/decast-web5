<template>
  ...
  >
    ...
    >
      ...
      <p>Welcome to Decast.live!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Decast.live's Website, located at https://decast.live/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Decast.live if you do not agree to
      ...
      <p>
        ...
        subject to, prevailing law of pt. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing Decast.live, you agreed to
        use cookies in agreement with the Decast.live's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Decast.live and/or its licensors own the
        intellectual property rights for all material on Decast.live. All
        intellectual property rights are reserved. You may access this from
        Decast.live for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Decast.live</li>
        <li>Sell, rent or sub-license material from Decast.live</li>
        <li>Reproduce, duplicate or copy material from Decast.live</li>
        <li>Redistribute content from Decast.live</li>
      </ul>
      ...
      <p>
        ...
        Decast.live does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Decast.live,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Decast.live shall not be
      ...
      <p>
        Decast.live reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Decast.live a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Decast.live; and (d) the link
      ...
      <p>
        ...
        e-mail to Decast.live. Please include your name, your organization name,
      ...
      <p>
        No use of Decast.live's logo or other artwork will be allowed for
