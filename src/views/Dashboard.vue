  ...
  <div id="knowledge-base-page" class="container-fluid mx-auto">
      ...
      >
        ...
        <div class="vx-row">
          ...
          <div class="vx-col w-full md:w-1/3 sm:w-1/1 p-2">
            <vs-button size="large" :disabled="btndisable" @click="blockchain"
              >Create A New Video</vs-button
            >
            <br /><br />
            <div v-if="!btndisable"><br /><br /><br /></div>
    ...
    <div>
      ...
      <feather-icon
        ...
        :svgClasses="{
          'text-primary stroke-current': currentItemView == 'item-grid-view',
        }"
      />
      <feather-icon
        icon="ListIcon"
        ...
        :svgClasses="{
          'text-primary stroke-current': currentItemView == 'item-list-view',
        }"
      />
    </div>
