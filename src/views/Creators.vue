        ...
        <div class="lg:w-full md:w-8/12 sm:w-10/12 w-full">
          <div class="op-1">
            <h1 id="head-id" class="sm:text-5xl xl:text-6xl text-4xl text-left">
              Turn your Event Audience into NFT Fan Clubs.
            </h1>
          </div>
          <div class="op-2 mt-2">
            <p class="text-base text-left">
              CAST a spell in your townhalls, launch parties,
              <br class="xl:block hidden" />and AMAs with Web3 Casting.
            </p>
          </div>
          <div class="op-3">
            <button @click="open">
        ...
        <div class="flex flex-col text-grey gap-4 w-full col-span-1 lg:order-last lg:justify-end lg:items-end">
          <div class="flex-col flex md:w-10/12 sm:w-10/12">
            ...
            <p class="text-base text-grey font-normal">
              ...
              A fan club activation point for your events to reward audiences
              for their trust, loyalty and contributions. Our tools allow
              knowledge creators and brands to start and manage fan clubs. All
              of this driven by innovative NFT and Token subscriptions models.
              <br /><br />
