// Contract erc 721 Standard
// const { ethers } = require("hardhat");
import { ethers } from 'ethers';

async function dropNft(payload) {
  ...
  const transactionSuccessfull = receipt.transactionHash;
